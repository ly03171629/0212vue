  ...
  <div role="tabpanel" class="tab-pane active" id="Message">
    <ul class="list-group">
      <li class="list-group-item" v-for="(m) in messages" :key="m.id">
        ...
        <!-- <a href="##">{{m.content}}</a> -->
        <!-- <router-link :to="'/home/message/info/'+ m.id + '/'+ m.content">{{m.content}}</router-link> -->
        <router-link :to="{name:'msgInfo',params:{msgId:m.id,msgContent:m.content}}">{{m.content}}</router-link>
